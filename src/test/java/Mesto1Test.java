...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTdjMDE1NzQ0YWM0ZTAwM2RiY2M2ODciLCJpYXQiOjE3MDI2MjU2MjQsImV4cCI6MTcwMzIzMDQyNH0.DzF9ayclQEbWevDD4iT5Ft2fezX2pty94n6LkCTnDXk";
    ...
    public void addNewPhoto() {
        given()
                ...
                .then().statusCode(200); // 201 Проверяем код ответа
    }
